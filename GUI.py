...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        img = pg.QtGui.QGraphicsPixmapItem(pg.QtGui.QPixmap('icons/Green-Glow.png'))
        self.backCircle.addItem(img)
        img2 = pg.QtGui.QGraphicsPixmapItem(pg.QtGui.QPixmap('icons/Orange-Glow.png'))
        img3 = QtGui.QIcon('icons/Brake.svg')
