...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_up.setHorizontalSpacing(10)
        ...
        self.verticalLayout_break.addWidget(self.brake_bar1, 0, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignTop)
        ...
        self.verticalLayout_break.addWidget(self.brake_bar2, 0, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignTop)
        ...
        self.verticalLayout_break.addWidget(self.brake_bar3, 0, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignTop)
        ...
        self.gridLayout_up.addWidget(self.brake_bar, 1, 1, 1, 1, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignTop)
        self.backCircle = QtWidgets.QWidget(self.up)
        self.backCircle.setMinimumSize(QtCore.QSize(280, 300))
        ...
        self.feedback.setMinimumSize(QtCore.QSize(200, 200))
        self.feedback.setMaximumSize(QtCore.QSize(320, 320))
        self.feedback.setFocusPolicy(QtCore.Qt.TabFocus)
        self.feedback.setText("")
        self.feedback.setObjectName("feedback")
        self.backCircleLayout.addWidget(self.feedback, 0, 0, 1, 1, QtCore.Qt.AlignHCenter)
        self.gridLayout_up.addWidget(self.backCircle, 1, 2, 2, 1, QtCore.Qt.AlignHCenter)
        ...
        self.gridLayout_up.addWidget(self.turn_level, 2, 3, 1, 1)
        ...
        self.verticalLayout_acc.addWidget(self.acc_bar1, 0, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignTop)
        ...
        self.verticalLayout_acc.addWidget(self.acc_bar2, 0, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignTop)
        ...
        self.verticalLayout_acc.addWidget(self.acc_bar3, 0, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignTop)
        ...
        self.gridLayout_up.addWidget(self.acc_bar, 1, 0, 1, 1, QtCore.Qt.AlignTop)
        ...
        self.gridLayout_up.addWidget(self.swerve_bar, 1, 4, 1, 1)
        ...
        self.gridLayout_up.addWidget(self.turn_bar, 1, 3, 1, 1)
        ...
        self.gridLayout_up.addWidget(self.swerve_level, 2, 4, 1, 1)
